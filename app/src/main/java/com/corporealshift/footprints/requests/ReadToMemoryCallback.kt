...
package com.corporealshift.footprints.requests
...
internal abstract class ReadToMemoryCallback : UrlRequest.Callback() {
    ...
    companion object {
        ...
        private const val BYTE_BUFFER_CAPACITY_BYTES = 640 * 1024
    }
}